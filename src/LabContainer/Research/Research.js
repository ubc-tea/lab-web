  ...
  const SCREEN_CONSTSANTS = [
    {
      ...
      description: "Performing diagnosis and helping patients manage treatment require complex reasoning and decision-making by doctors based often requires experts collaboratively make the decisions. In recent years, large language models (LLMs) has achieved significant advancement, prompting the exploration of developing decision support systems for doctors to help improve clinical care. This has resulted in the emergence of plethora of multi-agent systems (MAS) with foundation model-based agents providing interactive decision support based on queries about patient conditions.  In this project, we develop MAC-Health, as AI copilot in action for doctors or medical school students. It consists two types of agents: 1) medical domain expert agents, which are medical Q&A agents finetuned on hospital data through federated learning (FL), and 2) ecosystem management agents, which performs assistive roles such as coordination, prompt generation, dynamic context-aware workflow triggering, uncertainty-based follow up questioning, optimization of MAS organizational structure, and uncovering potential issues among diagnostic responses from multiple medical domain expert agents, etc.",
    ...
    }, 
    {
      ...
      Imgurl:require("../../assets/Research/gmvaluator.jpg"),
    },
    {
      title:
