    ...
    return (
        <div className="gal-parent" id={props.id || ""}>
            ...
            <div className="gallery-container">
                <div id="galleryCarousel" className="carousel slide" data-ride="carousel" data-interval="4000">
                    ...
                    <div className="carousel-inner">
                        {[
                            ...
                            <div key={index} className={`carousel-item ${index === 0 ? "active" : ""}`}>
                                <img className="d-block w-100 gallery-img" src={require(image)} alt={`Slide ${index + 1}`} />
                            </div>
                        ))}
                    </div>
